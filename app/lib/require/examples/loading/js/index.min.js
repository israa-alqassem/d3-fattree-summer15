...
function Route(name) {
    ...
    this.name = name;
    this.path = require.resolve("./index.src");
}

module.exports = Route;


}, "../route/index.src", "../route"],
[function(__require__, require, exports, __filename, __dirname, module, process, Buffer, global) {

module.exports = {
  "name": "require.src",
  "version": "0.3.91",
  "description": "node.src require loader/compiler for the browser and node.src",
  "repository": {
    "type": "git",
    "url": "https://github.com/nathanfaucett/require.src.git"
  },
  "bin": {
    "requirejs": "bin/index.src"
  },
  "main": "build/require.min.src",
  "keywords": [
    "require",
    "require.src",
    "loader",
...
}, "utils/../Gruntfile.src", "../node_modules/utils"],
[function(__require__, require, exports, __filename, __dirname, module, process, Buffer, global) {
