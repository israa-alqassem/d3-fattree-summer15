        ...
        [
            function(__require__, require, exports, __filename, __dirname, module, process, Buffer, global) {
                ...
                function resolveFilename(path, parent) {
                    ...
                    if (path[path.length - 1] === "/") path += "index.src";
                    if (!hasExtension.test(path)) path += ".src";
                ...
                function resolveNodeModule(path, parent) {
                    ...
                    if (found) {
                        ...
                        if (relativePath) {
                            ...
                            if (resolved[resolved.length - 1] === "/") resolved += "index.src";
                            if (!hasExtension.test(resolved)) resolved += ".src";
